...
class EditTaskView extends StatefulWidget {
  ...
  final String userId;
  const EditTaskView({super.key, required this.model, required this.userId});

  @override
  EditTaskState createState() => EditTaskState();
}

class EditTaskState extends State<EditTaskView> {
  ...
  void initState() {
    ...
    _category = widget.model.category;
      ...
      body: Padding(
        ...
        child: BlocConsumer<TaskBloc, TaskState>(
          listener: (context, state) {
            if (state.updateTaskStatus == RequestStatus.failure) {
              myToast(
                text: state.updateTaskFailure?.message ?? '',
                isError: true,
              );
            }
            if (state.updateTaskStatus == RequestStatus.success) {
          ...
          builder: (context, state) {
            if (state.updateTaskStatus == RequestStatus.loading) {
              return Center(
                child: Lottie.asset(
